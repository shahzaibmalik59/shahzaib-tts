// ====== Shahzaib Text to Voice Expert - app.js (UI -> API) ======
// LOCAL dev: keep this on http://localhost:3000 while `vercel dev` runs
// PROD: change to your Vercel URL, e.g. https://shahzaib-tts-api.vercel.app
...
(async function loadVoices(){
  try{
    ...
    els.voiceCount.textContent = "Loaded 2 fallback voices.";
  }
})();

// --- synthesize click handler ---
els.speak.addEventListener("click", async () => {
  ...
  try{
    ...
    // handle both raw audio and base64 (just in case)
    ...
    if (ct.startsWith("audio/")){
      ...
      // some hosts might return base64 text
